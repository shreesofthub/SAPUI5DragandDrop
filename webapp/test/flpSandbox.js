					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Drag and Drop Examples from UPE",
					...
					"config": {
						"inbounds": {
							"dragdrop-display": {
								...
								"action": "display",
								"description": "Drag and Drop Examples",
								"title": "Drag and Drop Examples from UPE",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dragdrop",
									"url": sap.ui.require.toUrl("dragdrop")
								}
							}
						}
					}
